...
## 🎓 Section 13: Capstone - End-to-End Employee Onboarding Workflow
...
### 13.1 The Intake (Jira Service Management)
...
### 13.2 Identity Provisioning (Active Directory & PowerShell)
...
### 13.3 Cloud Sync & SaaS Licensing (Entra ID & M365)
...
### 13.4 Endpoint Provisioning & Verification (Windows 11)
> Logged into the Intune-managed Windows 11 endpoint using the synced cloud credentials (`jbelita@belitalab.onmicrosoft.com`). Verified forced password reset, successful Single Sign-On (SSO) to Microsoft 365 services via Edge/Teams, and confirmed access to the restricted `\\10.0.0.10\Finance` local file share via inherited local Kerberos authentication.

### 13.5 Ticket Closure & Documentation
